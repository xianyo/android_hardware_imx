/*
 * Copyright (C) 2013-2014 Embest Tech, Inc.
 *
...
status_t Ov2656Csi::initSensorInfo(const CameraInfo& info)
{
    if (mCameraHandle < 0) {
    ...
    FLOGI("ov2656Csi, mFocalLength:%f, mPhysicalWidth:%f, mPhysicalHeight %f",
...
int Ov2656Csi::getCaptureMode(int width, int height)
{
    int capturemode = 0;
